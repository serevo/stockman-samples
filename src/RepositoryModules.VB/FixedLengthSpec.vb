...
Public Class FixedLengthSpec
    ...
    Public Function TryGeneraLabel(ByVal Symbol As Symbol, ByRef Label As ILabel) As Boolean
        ...
        If Symbol.Value.Length >= minLength And (String.IsNullOrEmpty(PrefixKey) OrElse Symbol.Value.StartsWith(PrefixKey)) Then
